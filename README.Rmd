...
[x] First I build the scaffolding for api calls
...
a query field like "prefix=gree&genre=rock" that you can fill yourself.
I might add functions on top that would fill in some of those fields for you.

Every endpoint has the option to fill in parameters or use `query` to type it
yourself. 
